...
class SearchBgHelper(
    ...
    private var startLine = 0  // № строки
    private var endLine = 0  // № строки
    private var startOffset = 0  //отступ от начала строки
    private var endOffset = 0 // отступ от конца строки
