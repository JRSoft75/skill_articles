...
object ArticlesRepository {
    ...
    fun insertArticleToDb(articles: List<ArticleItemData>) {
...
class ArticleDataSource(private val strategy: ArticleStrategy) : PositionalDataSource<ArticleItemData>() {
    override fun loadInitial(
        ...
        Log.e(
            "ArticlesRepository",
            "loadInitial: start > ${params.requestedStartPosition}  size > ${params.requestedLoadSize}")
    ...
    override fun loadRange(params: LoadRangeParams, callback: LoadRangeCallback<ArticleItemData>) {
        ...
        Log.e(
            "ArticlesRepository",
            "loadRange: start > ${params.startPosition}  size > ${params.loadSize}")
